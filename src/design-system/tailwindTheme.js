 ...
 *
 * Purpose:
 * Maps design-system CSS variables from `theme.css`
 * into reusable Tailwind utility classes.
 
 * Example:
 * --ds-color-brand-500
 *      ↓
 * bg-ds-brand-500 / text-ds-brand-500
 
 * Important:
 * - This file DOES NOT define actual colors/styles.
 * - Actual values live in `theme.css` as CSS variables.
 
 * This file only teaches Tailwind how to expose
 * those variables as utility classes.
 */
